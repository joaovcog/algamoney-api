...
//		OutputStream out = new FileOutputStream("C:/Users/João Victor/anexo--" + anexo.getOriginalFilename());
//		
...
//		out.close();
	...
	public ResponseEntity<byte[]> relatorioPorPessoa(
			...
			@RequestParam @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate dataFinal) throws JRException {
	...
	@GetMapping(params = "resumo") // parâmetro que indica que esse método será chamado caso haja o parâmetro
									// resumo na requisição
	@PreAuthorize("hasAuthority('ROLE_PESQUISAR_LANCAMENTO') and #oauth2.hasScope('read')")
